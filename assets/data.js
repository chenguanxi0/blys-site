...
const DAILY_LOG = [
  ...
  },
  {
    ...
    "note": "持仓截图(平安证券 **5362)。当日参考盈亏 -12,174.00 / -2.17%，总市值 248,319.00，可用资金 300,581.73，仓位 45.2%。清仓中石科技1100股（亏226.26），新买入英维克2000股；宝鼎科技成本由55.491变为59.439、股数仍为1300且可用0，疑似做T或加仓；中钨高新未动、T+1已解锁。",
    "valid": true,
    "trades": [
      {
        "action": "sell",
