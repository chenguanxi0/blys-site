...
begin
  ...
  if coalesce(v_me.is_admin, false) = true or v_me.email = '491788533@qq.com' or v_me.nickname = '白鹿原上' then
...
begin
  ...
  return coalesce(v_me.is_admin, false) = true
    or v_me.email = '491788533@qq.com'
    or v_me.nickname = '白鹿原上'
...
begin
  ...
  v_is_admin := coalesce(v_me.is_admin, false) = true or v_me.email = '491788533@qq.com' or v_me.nickname = '白鹿原上';
